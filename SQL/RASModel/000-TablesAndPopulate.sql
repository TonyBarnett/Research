...
CREATE TABLE sourceData (
	intBatchNumber int          NOT NULL IDENTITY(1, 1),
	...
	CONSTRAINT sourceData_PK           PRIMARY KEY (intBatchNumber, strProductId, strIndustryId),
...
CREATE TABLE results (
	...
	CONSTRAINT results_PK            PRIMARY KEY (intBatchNumber, strProductId, strIndustryId),
	CONSTRAINT results_FK_sourceData FOREIGN KEY (intBatchNumber, strProductId, strIndustryId) REFERENCES sourceData (intBatchNumber, strProductId, strIndustryId),
